...
public class AxisDrawer : MonoBehaviour
{
    ...
    void DrawAxes()
    {
        ...
        if (dataPoints.Count >= 2)
        {
            ...
            Vector3 xAxisEnd = new Vector3(maxY, 0, 0);
    ...
    void SpawnCube()
    {
        ...
        GameObject cube = Instantiate(cubePrefab, new Vector3(halfMaxY, halfMaxY, 0), Quaternion.identity);
        cube.transform.localScale = new Vector3(maxY, maxY, maxY);
    }
}
